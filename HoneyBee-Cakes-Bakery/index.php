...
<head>
  ...
  <title>HoneyBee Cakes Bakery</title>
  <!--Bootstrap -->
        ...
        <div class="row">
          <div class="col-md-5 col-md-push-7">
            <div class="banner_content">
              ...
              <a href="cake-listing.php" class="btn">Order Now <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container div_zindex">
      ...
      <div class="row">
        <div id="testimonial-slider">
          ...
          $tid = 1;
          $sql = "SELECT hbcb_testimonial.Testimonial,hbcb_users.FullName from hbcb_testimonial join hbcb_users on hbcb_testimonial.UserEmail=hbcb_users.EmailId where hbcb_testimonial.status=:tid";
